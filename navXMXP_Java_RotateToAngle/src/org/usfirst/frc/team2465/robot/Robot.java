...
public class Robot extends SampleRobot implements PIDOutput {
    ...
    final static int frontLeftChannel	= 25;
    final static int rearLeftChannel	= 24;
    final static int frontRightChannel	= 22;
    final static int rearRightChannel	= 23;
        
    public Robot() {
    	
    	CANTalon LeftFront = new CANTalon(25);
    	CANTalon LeftRear = new CANTalon(24);
    	CANTalon RightFront = new CANTalon(22);
    	CANTalon RightRear = new CANTalon(23);
...
//            	if (currentRotationRate < 0.26) {
//            		currentRotationRate = currentRotationRate * 3;
//            	}
